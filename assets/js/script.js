...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  if (typeof gsap !== "undefined" && typeof ScrollTrigger !== "undefined") {
    ...
    // Stagger animation for cleaning problem cards
    gsap.from(".cleaning-problem-card", {
      scrollTrigger: {
        trigger: ".cleaning-problems",
        start: "top 85%",
        toggleActions: "play none none none"
      },
      y: 50,
    ...
    // Stagger animation for cleaning feature cards
    gsap.from(".cleaning-feature-card", {
      scrollTrigger: {
        trigger: ".cleaning-features",
        start: "top 85%",
        toggleActions: "play none none none"
      },
      y: 50,
